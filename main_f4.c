...
#define OTP_BASE			0x1fff7800   /*一次性可编程OTP，起始地址*/
#define OTP_SIZE			512          /*512个字节*/
#define UDID_START		        0x1FFF7A10  /*唯一器件标志符UDID，起始地址， 96位=3*32bit*/

// address of MCU IDCODE
#define DBGMCU_IDCODE		0xE0042000 /*MCU器件ID号  存储器地址*/
#define STM32_UNKNOWN	0
#define STM32F40x_41x	0x413  /*ID号存储器  DEV_ID(11:0)*/
#define STM32F42x_43x	0x419 /*dev_id*/
#define STM32F42x_446xx	0x421

#define REVID_MASK	0xFFFF0000  /*15:0 REV_ID in DBGMCU_IDCODE*/
#define DEVID_MASK	0xFFF		/*11:0 DEV_ID in DBGMCU_IDCODE*/

/* magic numbers from reference manual */

typedef enum mcu_rev_e {  /*芯片对应的REV_ID in DBGMCU_IDCODE*/
...
#define BOOT_RTC_SIGNATURE          0xb007b007 /*后备寄存器中保存的boot签名，如果有则执行bootloader*/
